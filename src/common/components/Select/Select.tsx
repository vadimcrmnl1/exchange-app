...
import {currencyActions} from "../../../features/Currencies/currencies-reducer";
...
export const options = [
    ...
    {value: 'BAM', label: 'Bosnia and Herzegovina Mark'},
    ...
    {value: 'UZS', label: 'Uzbekistani So\'m'},
...
export const SelectComponent: React.FC<SelectPropsType> = ({type}) => {
    const dispatch = useAppDispatch()

    const handleChangeCurrency = (selectOptions: any) => {
        if (type === 'first') {
            dispatch(currencyActions.setFirstCurrency({firstCurrency: selectOptions.value}))
        }
        if (type === 'second') {
            dispatch(currencyActions.setSecondCurrency({secondCurrency: selectOptions.value}))
        }
    }
    return (
        <div className={s.selectContainer}>
            <Select className={s.select} placeholder={'Choose currency'} onChange={handleChangeCurrency}
                    options={options}/>
        </div>
